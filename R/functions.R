...
#' @param verbose Logical; whether the accomplishment of the evaluation of each network node should be printed (default is FALSE).
...
sirir <- function(graph, vertices = V(graph),
                  beta = 0.5, gamma = 1, no.sim = igraph::vcount(graph)*100,  
                  ncores = "default", seed = 1234, verbose = FALSE) {
